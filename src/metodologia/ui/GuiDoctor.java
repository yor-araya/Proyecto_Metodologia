...
public class GuiDoctor extends javax.swing.JFrame {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(jLabelESTADO, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(126, 126, 126)
    ...
    private void jButtonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGuardarActionPerformed
        ...
        String datos = "idDoctor->'"+id+"',idEspecialidad->'"+especialidad+"',"
                + "nombre->'"+nombre+"',telefono->'"+telefono+"',correo->'"+correo+"'";
        String condicion= "";
        boolean respuesta;
        if(jTextFieldIdentificacion.getText().length()==0){
            respuesta = cone.agregar("Doctores",datos);
        }
        else{
            respuesta = cone.editar("Doctores",datos, condicion);
        }
        if(respuesta){
    ...
    private void imprimirselect(){
        ...
        // = cone.imprimir(data, condicion, order);
